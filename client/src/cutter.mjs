...
if (!Object.getOwnPropertyDescriptor(Module["ready"], "_doubler")) {
 Object.defineProperty(Module["ready"], "_doubler", {
  configurable: true,
  get: function() {
   abort("You are getting _doubler on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
 Object.defineProperty(Module["ready"], "_doubler", {
  configurable: true,
  set: function() {
   abort("You are setting _doubler on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
}

if (!Object.getOwnPropertyDescriptor(Module["ready"], "_cut_video")) {
 Object.defineProperty(Module["ready"], "_cut_video", {
  configurable: true,
  get: function() {
   abort("You are getting _cut_video on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
 Object.defineProperty(Module["ready"], "_cut_video", {
  configurable: true,
  set: function() {
   abort("You are setting _cut_video on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
}

if (!Object.getOwnPropertyDescriptor(Module["ready"], "_cut_video1")) {
 Object.defineProperty(Module["ready"], "_cut_video1", {
  configurable: true,
  get: function() {
   abort("You are getting _cut_video1 on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
 Object.defineProperty(Module["ready"], "_cut_video1", {
  configurable: true,
  set: function() {
   abort("You are setting _cut_video1 on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
}
...
if (!Object.getOwnPropertyDescriptor(Module["ready"], "")) {
 Object.defineProperty(Module["ready"], "", {
  configurable: true,
  get: function() {
   abort("You are getting  on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
 Object.defineProperty(Module["ready"], "", {
  configurable: true,
  set: function() {
   abort("You are setting  on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
}
...
var wasmBinaryFile = "/cutter.wasm";
...
function _av_dump_format() {
 err("missing function: av_dump_format");
 abort(-1);
}

function _av_frame_alloc() {
 err("missing function: av_frame_alloc");
 abort(-1);
}

function _av_frame_free() {
 err("missing function: av_frame_free");
 abort(-1);
}

function _av_frame_get_best_effort_timestamp() {
 err("missing function: av_frame_get_best_effort_timestamp");
 abort(-1);
}

function _av_init_packet() {
 err("missing function: av_init_packet");
 abort(-1);
}

function _av_packet_rescale_ts() {
 err("missing function: av_packet_rescale_ts");
 abort(-1);
}

function _av_packet_unref() {
 err("missing function: av_packet_unref");
 abort(-1);
}

function _av_read_frame() {
 err("missing function: av_read_frame");
 abort(-1);
}

function _av_register_all() {
 err("missing function: av_register_all");
 abort(-1);
}

function _av_rescale_q() {
 err("missing function: av_rescale_q");
 abort(-1);
}

function _av_write_frame() {
 err("missing function: av_write_frame");
 abort(-1);
}

function _av_write_trailer() {
 err("missing function: av_write_trailer");
 abort(-1);
}

function _avcodec_alloc_context3() {
 err("missing function: avcodec_alloc_context3");
 abort(-1);
}

function _avcodec_find_decoder() {
 err("missing function: avcodec_find_decoder");
 abort(-1);
}

function _avcodec_find_encoder() {
 err("missing function: avcodec_find_encoder");
 abort(-1);
}

function _avcodec_open2() {
 err("missing function: avcodec_open2");
 abort(-1);
}

function _avcodec_parameters_from_context() {
 err("missing function: avcodec_parameters_from_context");
 abort(-1);
}

function _avcodec_parameters_to_context() {
 err("missing function: avcodec_parameters_to_context");
 abort(-1);
}

function _avcodec_receive_frame() {
 err("missing function: avcodec_receive_frame");
 abort(-1);
}

function _avcodec_receive_packet() {
 err("missing function: avcodec_receive_packet");
 abort(-1);
}

function _avcodec_send_frame() {
 err("missing function: avcodec_send_frame");
 abort(-1);
}

function _avcodec_send_packet() {
 err("missing function: avcodec_send_packet");
 abort(-1);
}

function _avformat_alloc_output_context2() {
 err("missing function: avformat_alloc_output_context2");
 abort(-1);
}

function _avformat_find_stream_info() {
 err("missing function: avformat_find_stream_info");
 abort(-1);
}

function _avformat_new_stream() {
 err("missing function: avformat_new_stream");
 abort(-1);
}

function _avformat_open_input() {
 err("missing function: avformat_open_input");
 abort(-1);
}

function _avformat_write_header() {
 err("missing function: avformat_write_header");
 abort(-1);
}

function _avio_open() {
 err("missing function: avio_open");
 abort(-1);
}
...
var asmLibraryArg = {
 ...
 "av_packet_rescale_ts": _av_packet_rescale_ts,
...
var _cut_video = Module["_cut_video"] = createExportWrapper("cut_video");

var _cut_video1 = Module["_cut_video1"] = createExportWrapper("cut_video1");
